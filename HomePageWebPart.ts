...
<div style="padding: 20px;">
        <h2>Admin Portal</h2>
        <iframe
          src="https://apps.powerapps.com/play/e/default-ff36d087-cdf0-404f-8ab6-eace47cd06b2/a/1369f285-635f-4e7a-9fcb-a85483c82810?tenantId=ff36d087-cdf0-404f-8ab6-eace47cd06b2&sourcetime=1731845019670{1369f285-635f-4e7a-9fcb-a85483c82810}"
          width="100%"
          height="600px"
          style="border: none;"
        ></iframe>
      ...
      <header class="${styles.header}">
        <div class="${styles.container}">
          <div class="${styles.logo}">
            <img src="${this.context.pageContext.web.absoluteUrl}/SiteAssets/LOGO.png" alt="Capgemini Logo">
          </div>
